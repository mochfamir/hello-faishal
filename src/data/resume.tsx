...
export const DATA = {
  ...
  description:
    "I am a Fullstack Engineer specializing in TypeScript, React, Node.js, and Golang. I have experience in building scalable web applications, designing robust system architectures, and streamlining development workflows. With a strong foundation in CI/CD and cloud-based IAM automation, I focus on creating efficient, high-performance, and maintainable solutions.",
  // summary:
  //   "At the end of 2022, I quit my job as a software engineer to go fulltime into building and scaling my own SaaS businesses. In the past, [I pursued a double degree in computer science and business](/#education), [interned at big tech companies in Silicon Valley](https://www.youtube.com/watch?v=d-LJ2e5qKdE), and [competed in over 21 hackathons for fun](/#hackathons). I also had the pleasure of being a part of the first ever in-person cohort of buildspace called [buildspace sf1](https://buildspace.so/sf1).",
  summary:
    "At the start of my career, I dove deep into building impactful software solutions as a Fullstack Engineer. Over the years, I’ve had the opportunity to work on everything from internal platforms to automation tools, constantly improving operational efficiency and scalability. I’ve been fortunate to contribute to exciting projects at eFishery, Recharge Indonesia, and even in the IoT hardware space at PT Dycodex. With a background in both engineering and a strong drive for problem-solving, I’m constantly learning new ways to create seamless user experiences and innovative solutions. Outside of work, I’m passionate about pushing the boundaries of tech, whether it's automating internal processes or exploring new frontiers in the software world.",
  avatarUrl: "/me.jpg",
  skills: [
    "React",
    "Next.js",
